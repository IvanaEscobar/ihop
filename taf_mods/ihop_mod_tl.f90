...
!==============================================
  ...
  if (mpi_ihop_ray2d == mpi_datatype_null) then
    call ray2dpttypeinit( ray2d(1),ray2d(2),ray2d_type_committed )
  endif
...
!----------------------------------------------
  if (mpi_ihop_ray2d == mpi_datatype_null) then
    call ray2dpttypeinit_tl( ray2d(1),ray2d_tl(1),ray2d(2),ray2d_tl(2),ray2d_type_committed )
  endif
  call mpi_bcast( beam%nsteps,1,mpi_integer,root,comm,ierr )
  call mpi_bcast( ray2d_tl,nmax,mpi_ihop_ray2d,root,comm,ierr )
  call mpi_bcast( ray2d,nmax,mpi_ihop_ray2d,root,comm,ierr )
...
!==============================================
  ...
  subroutine ray2dpttypeinit( singleray2d, nextray2d, type_committed )
!******************************************************************
!******************************************************************
!** This routine was generated by Automatic differentiation.     **
!** FastOpt: Transformation of Algorithm in Fortran, TAF 6.8.11  **
...
!==============================================
  ...
  subroutine ray2dpttypeinit_tl( singleray2d, singleray2d_tl, nextray2d, nextray2d_tl, type_committed )
!******************************************************************
!******************************************************************
!** This routine was generated by Automatic differentiation.     **
!** FastOpt: Transformation of Algorithm in Fortran, TAF 6.8.11  **
