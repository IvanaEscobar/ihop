...
C==============================================
      use ssp_mod, only : init_varia_ssp,ssp_tl,sspvariable_tl
...
C----------------------------------------------
      ihop_ssp_tl(:,:,:,:,:) = 0.d0
      ssp_tl%c_tl = (0._ikind3,0._ikind3)
      ssp_tl%cz_tl = (0._ikind4,0._ikind4)
...
C referencing used modules
C==============================================
      use ssp_mod, only : init_varia_ssp
