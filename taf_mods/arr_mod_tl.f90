...
! declare local variables
!==============================================
  integer(kind=mpi_address_kind) :: addr(4)
  ...
  subroutine arrivaltypeinit_tl( singlearrival, singlearrival_tl )
!******************************************************************
!******************************************************************
!** This routine was generated by Automatic differentiation.     **
!** FastOpt: Transformation of Algorithm in Fortran, TAF 6.8.11  **
...
!==============================================
  integer :: arrsize
  integer :: ierr
  integer :: mpi_ihop_arrivalh

!----------------------------------------------
! TANGENT LINEAR AND FUNCTION STATEMENTS
!----------------------------------------------
  if (mpi_ihop_arrival == mpi_datatype_null) then
    call arrivaltypeinit_tl( arr(1,1,1),arr_tl(1,1,1) )
  endif
  arrsize = size(narrival)
  call mpi_bcast( narrival,arrsize,mpi_integer,root,comm,ierr )
  arrsize = size(arr)
  mpi_ihop_arrivalh = 0
  call mpi_bcast( arr_tl,arrsize,mpi_ihop_arrivalh,root,comm,ierr )
  call mpi_bcast( arr,arrsize,mpi_ihop_arrival,root,comm,ierr )
