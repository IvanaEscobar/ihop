...
double precision, private :: geninfluence(35504)
...
double precision, private :: geninfluence_tl(35504)
...
!----------------------------------------------
  ...
  arrsize = size(geninfluence_tl)
  call mpi_bcast( geninfluence_tl,arrsize,mpi_double_precision,root,comm,ierr )
  arrsize = size(geninfluence)
  call mpi_bcast( geninfluence,arrsize,mpi_double_precision,root,comm,ierr )
  arrsize = size(arr)
